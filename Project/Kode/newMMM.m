...
%% User Inputs
input_csv = 'C:\Users\Christian Lykke\Documents\Skole\Aalborg Universitet\ESD6\Project\Kode\acceptanceTest\eggShellFoamTest1\IRAndFFT\sweepEggShellFoamCH12IRAndFFT.csv'; % Your local path
...
x2 = 282.84e-3;      % Second mic position [m]
s = abs(x2 - x1);    % Distance between microphones [m]
...
fprintf('Expected Absorption (standing wave method): ~0.45\n');
