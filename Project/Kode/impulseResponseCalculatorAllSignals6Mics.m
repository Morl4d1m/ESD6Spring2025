...
% === Signal file paths ===
file_paths = {
    'sweepCombined6MicsCH12.csv', ...
    'sine520Combined6MicsCH12.csv', ...
    'whiteNoiseCombined6MicsCH12.csv', ...
    'sineShifted180Combined6MicsCH12.csv', ... 
    'sweepCombined6MicsCH34.csv', ...
    'sine520Combined6MicsCH34.csv', ...
    'whiteNoiseCombined6MicsCH34.csv', ...
    'sineShifted180Combined6MicsCH34.csv', ... 
    'sweepCombined6MicsCH56.csv', ...
    'sine520Combined6MicsCH56.csv', ...
    'whiteNoiseCombined6MicsCH56.csv', ...
    'sineShifted180Combined6MicsCH56.csv'
